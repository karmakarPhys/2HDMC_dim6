...
class DecayTable {
  ...
  */
  ...
  std::complex<double>  hvv_coup_sq(int V, int h);
 ...
 private:
  ...
  //complex <double> hvv_coup_sq(int V, int h);
  double  hvv_onshell(int h, int V, double M);
  double  hvv_onshellp(int h, int V, double M);
  double  hvv_offshell(int h, int V, double M);
  double  hvv_offshellp(int h, int V, double M);
  double  hvv_all(int h, int V, double M);
  //double  hvv_allp(int h, int V);
